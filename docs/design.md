...
| `src/decompile/stages.rs` | 固定阶段调度表，统一处理阶段执行、timing、debug dump 与 target-stage 停止点 |
...
| 6 | AST | [6.ast.md](./design/6.ast.md) | `lower_ast_for_generate(state, context)` |
| 7 | Readability | [7.readability.md](./design/7.readability.md) | `make_readable(state, context)` |
| 8 | Naming | [8.naming.md](./design/8.naming.md) | `assign_names(state, context)` |
